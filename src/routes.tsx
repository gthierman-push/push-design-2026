    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "milestones", element: <Placeholder title="Milestones" /> },
          { path: "performance", element: <Placeholder title="Performance" /> },
          { path: "surveys", element: <Placeholder title="Surveys" /> },
          { path: "time-off", element: <Placeholder title="Time Off" /> },
          { path: "tasks", element: <Placeholder title="Tasks" /> },
          {
            path: "applicant-tracking",
            element: <Placeholder title="Applicant Tracking" />,
          },
          { path: "payroll", element: <Placeholder title="Payroll" /> },
          { path: "timesheets", element: <Placeholder title="Timesheets" /> },
